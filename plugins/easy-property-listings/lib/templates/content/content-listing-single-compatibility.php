...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'epl-listing-single epl-property-single view-expanded epl-property-single-compatibility' ); ?>>
	<div class="entry-header epl-header epl-clearfix">
		...
		<div class="epl-tab-section epl-section-property-details">
			<!-- used to be tab-content -->
			<div class="t-content">

				<h4 class="tab-address">
	...
	<div class="entry-content epl-content epl-clearfix">
		...
		<div class="tab-wrapper">
			...
			<div class="epl-tab-section epl-section-contact">
			<h5 class="epl-tab-title"><?php echo __('Property Contact', 'epl'); ?></h5>
			<?php do_action('epl_property_contact'); ?>
			</div>
